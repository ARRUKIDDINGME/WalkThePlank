...
<context>
    ...
    <message>
        ...
        <translation type="vanished">Соединение через Tor было включено. Чтобы использовать эту функцию, вам нужно перезапустить SilentDragon.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">Соединение через Tor было отключено. Чтобы полностью отключиться от Tor, вам нужно перезапустить SilentDragon.</translation>
    </message>
    <message>
...
daemon=1</source>
        <translation type="vanished">Вы настроили hushd для запуска в качестве демона, что может вызвать проблемы с SilentDragon
...
Пожалуйста, установите  host/port и  user/password в меню Редактировать-&gt; Настройки.</translation>
    ...
    <message>
        ...
        <translation type="vanished">%1 не похоже на действительный адрес Hush.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">Повторно сканирует блокчейн для любых пропущенных транзакций кошелька и исправляет баланс вашего кошелька. Это может занять несколько часов. Вам нужно перезапустить SilentDragon, чтобы это вступило в силу</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">Перестраивает весь блокчейн из блока генезиса путем повторного сканирования всех файлов блоков. Это может занять несколько часов или дней, в зависимости от вашего оборудования. Вам нужно перезапустить SilentDragon, чтобы это вступило в силу</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">Адрес (z-Addr или t-Addr)</translation>
    </message>
    <message>

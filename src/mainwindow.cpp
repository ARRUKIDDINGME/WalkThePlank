    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->setupUi(this);
    logger = new Logger(this, QDir(QStandardPaths::writableLocation(QStandardPaths::AppDataLocation)).filePath("WalkThePlank.log"));
...
void MainWindow::setupSettingsModal() {
    ...
    QObject::connect(ui->actionSettings, &QAction::triggered, [=]() {
        ...
        QObject::connect(settings.comboBoxTheme, &QComboBox::currentTextChanged, [=] (QString theme_name) {
            ...
            QMessageBox::information(this, tr("Restart"), tr("Please restart WalkThePlank to have the theme apply"), QMessageBox::Ok);
        });
        ...
        if (settingsDialog.exec() == QDialog::Accepted) {
            ...
            if (!isUsingTor && settings.chkTor->isChecked()) {
                ...
                QMessageBox::information(this, tr("Enable Tor"),
                    tr("Connection over Tor has been enabled. To use this feature, you need to restart WalkThePlank."),
                    QMessageBox::Ok);
            }
            ...
            if (isUsingTor && !settings.chkTor->isChecked()) {
                ...
                QMessageBox::information(this, tr("Disable Tor"),
                    tr("Connection over Tor has been disabled. To fully disconnect from Tor, you need to restart WalkThePlank."),
                    QMessageBox::Ok);
            }
            ...
            if (showRestartInfo) {
                auto desc = tr("WalkThePlank needs to restart to rescan/reindex. WalkThePlank will now close, please restart WalkThePlank to continue");

                QMessageBox::information(this, tr("Restart WalkThePlank"), desc, QMessageBox::Ok);
...
void MainWindow::donate() {
    ...
    ui->MemoTxt1->setText(tr("Some feedback about WalkThePlank or Hush..."));

    ui->statusBar->showMessage(tr("Send Duke some private and shielded feedback about ") % Settings::getTokenName() % tr(" or WalkThePlank"));

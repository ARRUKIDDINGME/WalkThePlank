...
public:
    ...
    int main(int argc, char *argv[]) {
        ...
        parser.addPositionalArgument("ARRRUKIDDINGUri", "An optional ARRRUKIDDING URI to pay");
        ...
        QCoreApplication::setOrganizationName("ARRRUKIDDING");
        QCoreApplication::setApplicationName("WalkThePlank");
        ...
        w = new MainWindow();
        w->setWindowTitle("WalkThePlank v" + QString(APP_VERSION));
